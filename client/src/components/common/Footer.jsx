                   ...
                   px-3 cursor-pointer hover:text-richblack-50 transition-all duration-200`}
                    ...
                    <div className="text-center flex flex-col sm:flex-row ">
                        <div className="flex ">
                            ...
                            <Link to='https://github.com/Shreebhalerao' target="__blank" className="text-white hover:underline mr-1"
                            >
                                Shreeraj Bhalerao
                            </Link>
                        </div>
                    ...
                    <div className="flex items-center">
                        <a href="https://www.linkedin.com/in/shreeraj-bhalerao-4bb096294" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
                            <ImLinkedin2 size={17} />
                        </a>
                        <a href="https://github.com/Shreebhalerao" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
                            <ImGithub size={17} />
                        </a>
                    </div>
